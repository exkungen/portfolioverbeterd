...
<head>
    ...
    <meta name="keywords" content="front-end, main, website, development, webpagina">
    <meta name="description" content="Portfolio website voor het media college amsterdam.">
    <title>Menouer Nobach - Main Website</title>
...
<div class="projecten">
    <div class="container">
        ...
        <div class="col-sm-4" >
            ...
            <a href="http://23136.hosts.ma-cloud.nl"><img src="img/laptop.jpeg" class="img-thumbnail img-responsive" alt="Main Website"></a>
            </div>
        </div>
        <div class="col-sm-4">
            <h1>Main Website</h1>
