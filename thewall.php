...
<head>
    ...
    <meta name="keywords" content="the wall,melissa vriend, menouer nobach, php, html, css, mysql">
    <meta name="description" content="Portfolio website voor het media college amsterdam.">
    <title>Menouer Nobach - The Wall</title>
...
<div class="projecten">
    <div class="container">
        ...
        <div class="col-sm-4" >
            <a href="http://23136.hosts.ma-cloud.nl/school/p1.3/proj/thewall/index.php"><img src="img/thewall.jpg" class="img-thumbnail img-responsive" alt="The Wall"></a>
